...
function Navbar(props) {
  ...
  function searchedProd(prd) {
    ...
    if (x) {
      setResult(x)
      nav(`/searchedItems`, { state: result })
    }
    else console.log("not")
  }

  // let [hd,setHd]=useState("visible")
  // function blr(){
  //   setHd("hidden")
  // }
  // function blu(){
        ...
        <div className="navbar pt-0 pb-1">
          <div className="container pt-0 mx-0 mb-2 w-100">
            ...
            <div >
              ...
              <a className="btn btn-outline-primary rounded-pill px-3 mx-lg-1 mx-2 d-md-inline-block"  onClick={()=>logout()}>Log out</a>
